...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='留言评论表';

/*Data for the table `comment` */

insert  into `comment`(`id`,`article_id`,`user_nickname`,`comment`,`date`,`is_reported`) values (1,1,'sadsad','aaa','2019-12-30 00:50:33',0),(7,1,'sadsad','啊我死了','2019-12-30 08:50:33',0),(8,1,'sadsad','asdsad','2019-12-30 08:02:14',0);
